...
export interface IUsdtSwapFactoryInterface extends utils.Interface {
  functions: {
...
export interface IUsdtSwapFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IUsdtSwapFactoryInterface;
